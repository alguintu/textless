...
class ThemedText extends StatelessWidget {
  ...
  ThemedText get solidLine => textless(TextStyle(decorationStyle: TextDecorationStyle.solid));

  ThemedText get dottedLine => textless(TextStyle(decorationStyle: TextDecorationStyle.dotted));

  ThemedText get doubledLine => textless(TextStyle(decorationStyle: TextDecorationStyle.double));

  ThemedText get wavyLine => textless(TextStyle(decorationStyle: TextDecorationStyle.wavy));

  ThemedText get dashedLine => textless(TextStyle(decorationStyle: TextDecorationStyle.dashed));
  ...
  ThemedText get alphabeticBaseline => textless(TextStyle(textBaseline: TextBaseline.alphabetic));

  ThemedText get ideographicBaseline => textless(TextStyle(textBaseline: TextBaseline.ideographic));
...
extension TextLess on String {
  ...
  ThemedText get labelMedium => ThemedText(data: this, style: (t) => t.labelMedium!);
}
